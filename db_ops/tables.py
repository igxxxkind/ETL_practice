...
from .baseclasses import FertilizerBase, NPKRatioBase, SoilBase, PlantBase, WateringScheduleBase, HarvestBase, GardenBase

# simple SQL data table Model for Fertilizer
class NPKRatioSQL(NPKRatioBase, table=True):
...
class WateringSchedule(WateringScheduleBase, table=True):
    id: int| None = Field(default=None, primary_key=True)
